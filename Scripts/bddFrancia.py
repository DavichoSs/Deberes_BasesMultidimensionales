...
try:
    ...
    db = server.create('bddfrancia')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['bddfrancia']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(locations=[5.866315,47.270111,15.041932,55.099159])
twitterStream.filter(track=['#Tomorrowland','festival','electronica'])